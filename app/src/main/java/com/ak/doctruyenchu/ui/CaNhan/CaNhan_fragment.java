...
public class CaNhan_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =inflater.inflate(R.layout.fragment_ca_nhan_fragment, container, false);

//        Log.e("error","sf");
//        getParentFragmentManager().setFragmentResultListener("loginResult", this, new FragmentResultListener() {
//            @Override
//            public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
//                Log.e("error",result.getString(requestKey));
//            }
//        });
    ...
    private void setView(Fragment fragment,String tag){
        getChildFragmentManager()
                .beginTransaction()
                .replace(R.id.frg_trang_ca_nhan,fragment,tag)
                .commit();
    }
    ...
    public void onResume() {
        ...
        if (Constans.AUTH.getCurrentUser()==null){
            ...
            if (getParentFragmentManager().findFragmentByTag("CHUA_DANG_NHAP")==null){
                setView(new DaDangNhap(),"DA_DANG_NHAP");
            }
        }
            Log.e("error","da");
    }
